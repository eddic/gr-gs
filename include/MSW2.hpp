/*!
 * @file       MSW2.hpp
 * @brief      Declares the gr::Isatec::GuidedScrambling::MSW2 class
...
namespace gr
{
   ...
   namespace Isatec
   {
      ...
      namespace GuidedScrambling
      {
         ...
         {
         public:
            //! %Feedback mechanism for %MSW2 (mean squared weight dc^2) codeword analysis
            /*!
             * Here is where we store and pass on the RDS (running digital sum)
             * and RDSS (running digital sum-sum) value remaining at the end of
             * the analysis.
             *
             * @date    March 10, 2015
             * @author  Eddie Carle &lt;eddie@isatec.ca&gt;
            ...
            public:
               ...
               /*!
                * @return  Pointer to dynamically allocated %MSW2 Feedback copy.
                * @date    March 10, 2015
                * @author  Eddie Carle &lt;eddie@isatec.ca&gt;
                */
               ...
               std::complex<float> RDSS; //!< RDSS (running digital sum-sum) value at end of codeword
            };

            //! Perform %MSW2 analysis on a codeword
            /*!
             * This actually performs the %MSW2 analysis on the passed codeword using
             ...
             * codeword.
             *
             * @return  Floating point representation of the codeword's %MSW2
         ...
         private:
            Feedback m_feedback; //!< %Feedback from %MSW2 analysis
            float m_analysis; //!< Actual result from %MSW2 analysis
         };
      }
   }
}
